...
// LearnGithubDlg.cpp: 구현 파일
//

#include "pch.h"
#include "framework.h"
#include "LearnGithub.h"
#include "LearnGithubDlg.h"
...
CLearnGithubDlg::CLearnGithubDlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_LEARNGITHUB_DIALOG, pParent)
{
...
// CLearnGithubDlg 메시지 처리기

BOOL CLearnGithubDlg::OnInitDialog()
{
...
void CLearnGithubDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
//  이 함수를 호출합니다.
HCURSOR CLearnGithubDlg::OnQueryDragIcon()
{
